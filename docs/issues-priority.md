...
| ~~[#15](https://github.com/ZhannaM85/zm-index/issues/15)~~ | ~~docs: SessionStart hook for auto-rebuild in `.claude/settings.json`~~ | ~~Guide for setting up auto-rebuild on session start~~ |
